...
export default function Dashboard({ user, journey }: any) {
  return (
    <div className="flex flex-1 flex-col gap-4 border p-4">
      ...
      <section className="flex flex-col gap-4 lg:flex-row xl:gap-12">
        <ScrollShadow className="order-2 flex flex-col gap-4 rounded-xl border-2 border-secondary p-4 lg:order-1 lg:w-[20.6rem]">
        ...
        <div className="lg:order2 order-1 flex flex-col rounded-xl border-2 border-secondary p-4 lg:flex-1">
          main content
        </div>
      </section>
    </div>
